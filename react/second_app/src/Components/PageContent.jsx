    ...
    return (
        <>
            <div className="w3-content" style={{ "max-width": "2000px", "margin-top": "46px" }}>
                ...
                <div className="w3-container w3-content w3-center w3-padding-64" style={{ "max-width": "800px" }} id="band">
                ...
                <div className="w3-container w3-content w3-padding-64" style={{ "max-width": "800px" }} id="contact">
            ...
            <img src="https://www.w3schools.com/w3images/map.jpg" className="w3-image w3-greyscale-min" style={{width:"100%"}}></img>
        </>
    )
}
